 ...
 * icons the Plan editor draws furniture with — so what you see before adding an item
 * is the same shape you'll see once it's placed, not an unrelated generic swatch.
 * viewBox is sized to the item's own footprint (with padding) so a bar stool and a
 * 2m rug both fill their thumbnail similarly instead of one looking tiny.
 */
